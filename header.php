...
<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'retro' ); ?></a>
			...
			<div class="main">
				...
				<div class="sidebar s2">
					<?php if ( get_theme_mod('light-dark-switch','off') =='on' ): ?>
						<a href="#" id="btn-mode" title="<?php esc_html_e('Switch Color','retro'); ?>"><i class="fas fa-toggle-off"></i></a>
					<?php endif; ?>
