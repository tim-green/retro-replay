...
add_action( 'after_setup_theme', 'retro_load' ); 
...
if ( ! function_exists( 'retro_setup' ) ) {
    ...
    function retro_setup() {
        ...
        register_nav_menus( array(
            'mobile'    => esc_html__( 'Mobile', 'retro' ),
            'header'    => esc_html__( 'Header', 'retro' ),
            'footer'    => esc_html__( 'Footer', 'retro' ),
        ) );
    }
...
/*  Custom logo
/* ------------------------------------ */
if ( ! function_exists( 'retro_custom_logo' ) ) {
    
    function retro_custom_logo() {
        $defaults = array(
            'height'        => 120,
            'width'         => 400,
            'flex-height'   => true,
...
add_action( 'after_setup_theme', 'retro_custom_logo' );


/*  Custom header
/* ------------------------------------ */
if ( ! function_exists( 'retro_custom_header' ) ) {
    
    function retro_custom_header() {
        $args = array(
            'default-image' => false,
            'default-text'  => false,
            'width'         => 1120,
...
add_action( 'after_setup_theme', 'retro_custom_header' );


/*  Custom background
/* ------------------------------------ */
if ( ! function_exists( 'retro_custom_background' ) ) {
    
    function retro_custom_background() {
        $args = array();
        add_theme_support( 'custom-background', $args );
    }
    
}
add_action( 'after_setup_theme', 'retro_custom_background' );


/*  Deregister
/* ------------------------------------ */
if ( ! function_exists( 'retro_deregister' ) ) {
    
    function retro_deregister() {
        wp_deregister_style( 'wp-pagenavi' );
    }
    
}
add_action( 'wp_enqueue_scripts', 'retro_deregister', 100 );


/*  Register sidebars
/* ------------------------------------ */  
if ( ! function_exists( 'retro_sidebars' ) ) {

    function retro_sidebars()    {
        register_sidebar(array( 'name' => esc_html__('Primary','retro'),'id' => 'primary','description' => esc_html__("Normal full width sidebar","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>'));
        
        if ( get_theme_mod('footer-ads') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Footer Ads',"retro"),'id' => 'footer-ads', 'description' => esc_html__("Footer ads area","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        
        if ( get_theme_mod('frontpage-widgets-top') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Top 1','retro'),'id' => 'frontpage-top-1', 'description' => esc_html__("Frontpage area","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        if ( get_theme_mod('frontpage-widgets-top') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Top 2','retro'),'id' => 'frontpage-top-2', 'description' => esc_html__("Frontpage area","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        if ( get_theme_mod('frontpage-widgets-bottom') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Bottom 1','retro'),'id' => 'frontpage-bottom-1', 'description' => esc_html__("Frontpage area","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        if ( get_theme_mod('frontpage-widgets-bottom') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Bottom 2','retro'),'id' => 'frontpage-bottom-2', 'description' => esc_html__("Frontpage area","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        
        if ( get_theme_mod('footer-widgets') >= '1' ) { register_sidebar(array( 'name' => esc_html__('Footer 1','retro'),'id' => 'footer-1', 'description' => esc_html__("Widgetized footer","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        if ( get_theme_mod('footer-widgets') >= '2' ) { register_sidebar(array( 'name' => esc_html__('Footer 2','retro'),'id' => 'footer-2', 'description' => esc_html__("Widgetized footer","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        if ( get_theme_mod('footer-widgets') >= '3' ) { register_sidebar(array( 'name' => esc_html__('Footer 3','retro'),'id' => 'footer-3', 'description' => esc_html__("Widgetized footer","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
        if ( get_theme_mod('footer-widgets') >= '4' ) { register_sidebar(array( 'name' => esc_html__('Footer 4','retro'),'id' => 'footer-4', 'description' => esc_html__("Widgetized footer","retro"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
    }
...
if ( ! function_exists( 'retro_scripts' ) ) {
    ...
    function retro_scripts() {
        ...
        wp_enqueue_script( 'retro-fontawesome-kit', 'https://kit.fontawesome.com/c20cab8581.js');
...
add_action( 'wp_enqueue_scripts', 'retro_styles' );


/*  Light & dark mode switch
/* ------------------------------------ */
if ( ! function_exists( 'retro_switch' ) ) {

    function retro_switch() {
        ...
        if ( get_theme_mod('light-dark-switch','off') =='on' ) { 
            ...
            if ( in_array( $current_mode, array( 'light', 'dark' ) ) ) {
                wp_enqueue_style( 'retro-scheme', get_template_directory_uri() . '/' . esc_attr( $current_mode ) . '.css' );
            }
            wp_enqueue_script( 'retro-cookie', get_template_directory_uri() . '/js/cookie.min.js', array(), '2.2.0', true );
            wp_enqueue_script( 'retro-switch', get_template_directory_uri() . '/js/switch.js', array( 'jquery' ), '2.0', true );
            $data = array(
                'template_directory_uri'   => get_template_directory_uri(),
                'stylesheet_directory_uri' => get_stylesheet_directory_uri(),
                );
            wp_localize_script( 'retro-switch', 'retroObject', $data );
            
        }
    }

}
add_action( 'wp_enqueue_scripts', 'retro_switch' );
...
/*  Layout class
/* ------------------------------------ */
if ( ! function_exists( 'retro_layout_class' ) ) {
    
    function retro_layout_class() {
        // Default layout
        $layout = 'col-2cl';
        $default = 'col-2cl';
...
/* ------------------------------------ */
if ( ! function_exists( 'retro_sidebar_primary' ) ) {
    
    function retro_sidebar_primary() {
        // Default sidebar
        $sidebar = 'primary';
...
/* ------------------------------------ */
if ( ! function_exists( 'retro_sidebar_secondary' ) ) {

    function retro_sidebar_secondary() {
        // Default sidebar
        $sidebar = 'secondary';
...
/*  Social links
/* ------------------------------------ */
if ( ! function_exists( 'retro_social_links' ) ) {

    function retro_social_links() {
...
/*  Site name/logo
/* ------------------------------------ */
if ( ! function_exists( 'retro_site_title' ) ) {
...
/*  Blog title
/* ------------------------------------ */
if ( ! function_exists( 'retro_blog_title' ) ) {

    function retro_blog_title() {
        global $post;
...
/*  Related posts
/* ------------------------------------ */
if ( ! function_exists( 'retro_related_posts' ) ) {

    function retro_related_posts() {
        wp_reset_postdata();
        global $post;
...
/* ------------------------------------ */
if ( ! function_exists( 'retro_post_images' ) ) {

    function retro_post_images( $args=array() ) {
        global $post;
...
/* ------------------------------------ */
if ( ! function_exists( 'retro_get_featured_post_ids' ) ) {

    function retro_get_featured_post_ids() {
        $args = array(
...
/*  Body class
/* ------------------------------------ */
if ( ! function_exists( 'retro_body_class' ) ) {
    
    function retro_body_class( $classes ) {
        $classes[] = retro_layout_class();
...
add_filter( 'body_class', 'retro_body_class' );


/*  Excerpt ending
/* ------------------------------------ */
if ( ! function_exists( 'retro_excerpt_more' ) ) {
...
/*  Excerpt length
/* ------------------------------------ */
if ( ! function_exists( 'retro_excerpt_length' ) ) {
...
/* ------------------------------------ */  
if ( ! function_exists( 'retro_embed_html' ) ) {

    function retro_embed_html( $html, $url ) {
...
add_filter( 'embed_oembed_html', 'retro_embed_html', 10, 3 );


/*  Add responsive container to jetpack embeds
/* ------------------------------------ */  
if ( ! function_exists( 'retro_embed_html_jp' ) ) {

    function retro_embed_html_jp( $html ) {
        return '<div class="video-container">' . $html . '</div>';
    }

}
add_filter( 'video_embed_html', 'retro_embed_html_jp' );
...
/* ------------------------------------ */
if ( ! function_exists( 'retro_pre_get_posts' ) ) {

    function retro_pre_get_posts( $query ) {
        ...
        if ( $query->is_home() ) {
            ...
            if ( get_theme_mod('featured-posts-count','0') != '0' ) {
                // Get featured post ids
                $featured_post_ids = retro_get_featured_post_ids();
                // Exclude posts
...
add_action( 'pre_get_posts', 'retro_pre_get_posts' );

/*  Script for no-js / js class
/* ------------------------------------ */
if ( ! function_exists( 'retro_html_js_class' ) ) {

    function retro_html_js_class () {
        echo '<script>document.documentElement.className = document.documentElement.className.replace("no-js","js");</script>'. "\n";
    }
    
}
add_action( 'wp_head', 'retro_html_js_class', 1 );


/*  Admin panel css
/* ------------------------------------ */
if ( ! function_exists( 'retro_admin_panel_css' ) ) {
    
    function retro_admin_panel_css() {
        global $pagenow;
...
add_action( 'admin_head', 'retro_admin_panel_css' );


/*  TGM plugin activation
/* ------------------------------------ */
if ( ! function_exists( 'retro_plugins' ) ) {
    
    function retro_plugins() {   
        if ( get_theme_mod('recommended-plugins','on') =='on' ) {   
            ...
            $plugins = array(
                ...
                array(
                    'name' => esc_html__( 'Regenerate Thumbnails', 'retro' ),
                    'slug' => 'regenerate-thumbnails',
                ),
                array(
                    'name' => esc_html__( 'WP-PageNavi', 'retro' ),
                    'slug' => 'wp-pagenavi',
                )
            );  
            tgmpa( $plugins );
...
add_action( 'tgmpa_register', 'retro_plugins' );


/*  WooCommerce basic support
/* ------------------------------------ */
function retro_wc_wrapper_start() {
    echo '<div class="content">';
    echo '<div class="pad">';
}
function retro_wc_wrapper_end() {
    echo '</div>';
    echo '</div>';
}
remove_action( 'woocommerce_before_main_content', 'woocommerce_output_content_wrapper', 10);
remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10);
add_action('woocommerce_before_main_content', 'retro_wc_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'retro_wc_wrapper_end', 10);
...
/*  Flexslider featured
/* ------------------------------------ */
if ( ! function_exists( 'retro_flexslider_featured' ) ) {
    
    function retro_flexslider_featured() {
        ...
        if( is_home() && !is_paged() && ( get_theme_mod('featured-posts-count','0') !='0') ) {
            ...
            wp_add_inline_script( 'retro-scripts', $script );
            
        }
    }
    
}
add_action( 'wp_enqueue_scripts', 'retro_flexslider_featured' );
    

/*  Flexslider gallery post format
/* ------------------------------------ */
if ( ! function_exists( 'retro_flexslider_gallery' ) ) {

    function retro_flexslider_gallery() {
...
add_action( 'wp_enqueue_scripts', 'retro_flexslider_gallery' );


/*  Accessibility IE11 fix - https://git.io/vWdr2
/* ------------------------------------ */
function retro_skip_link_focus_fix() {
    ?>
    <script>
...
add_action( 'wp_print_footer_scripts', 'retro_skip_link_focus_fix' );